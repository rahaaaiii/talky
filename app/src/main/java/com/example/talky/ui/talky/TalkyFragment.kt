...
class TalkyFragment : Fragment() {
    ...
    private fun addMessageToChat(message: String, isUser: Boolean) {
        val textView = TextView(requireContext()).apply {
            ...
            // Apply styles based on whether it's a user or bot message
            if (isUser) {
                ...
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    gravity = android.view.Gravity.END // Align user messages to the right
                }
            } else {
                ...
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    gravity = android.view.Gravity.START // Align bot messages to the left
                }
            }
        }

        // Add the TextView to the messages container (inside ScrollView)
